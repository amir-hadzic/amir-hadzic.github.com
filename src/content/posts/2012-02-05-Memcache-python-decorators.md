...
projects, [texd](https://texd-app.appspot.com).
...
code listing that can be found [here](https://github.com/amir-hadzic/texd/blob/master/cache/decorators.py) in the texd project on github.
...
models](https://github.com/amir-hadzic/texd/tree/master/models).

<div class="recommended-reading">
    <p>If you like this article, you might enjoy this one too:
    <a href="/2011/02/06/Free-SMS-notifications-from-Google">Free SMS notifications from Google</a></p>
</div>
