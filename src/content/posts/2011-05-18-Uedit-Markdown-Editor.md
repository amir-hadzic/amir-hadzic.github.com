...
While working on the new, improved version of [Tutorijali.net](http://www.tutorijali.net) we have
...
The result is [Uedit](http://amir-hadzic.github.com/uedit), a markdown editor that **Just Works** in IE6+, Opera,
...
You can download uedit packaged in a Zip file [here](https://github.com/amir-hadzic/uedit/zipball/master). Or you can clone
the [repository at github](https://github.com/amir-hadzic/uedit).
...
[Goran Zdjelar](http://www.radar404.com) has helped with the design of uedit. He's responsible for
